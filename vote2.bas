...
Function NewPoll(name String) Uint64
	...
	39	STORE(name + "_close_at_block",0)
	40	PRINTF "New poll %s created!" name
	41	RETURN 0
End Function


Function SetPollBlockHeight(name String, blockHeight Uint64) Uint64	
	10	IF EXISTS(name + "_name") == 0 THEN GOTO 20
	11	PRINTF "Poll name already exist!"
	12	RETURN 1	
	...
	30	IF ClosePoll(name) > 0 THEN GOTO 40
	31	RETURN 1	 

	40	STORE(name + "_close_at_block",blockHeight)
	41	PRINTF "New blockHeight set: %d!" blockHeight	
	42	RETURN 0
End Function


Function ClosePoll(name String) Uint64 
...
Function ForceClosingPoll(name String) Uint64
	10	IF EXISTS(name + "_name") == 1 THEN GOTO 20
	11	PRINTF "This poll doesn't exist!"
	12	RETURN 1
...
Function RemoveVoter(name String, voter String) Uint64 
	10	IF EXISTS(name + "_name") == 1 THEN GOTO 20
	11	PRINTF "This poll doesn't exist!"
	12	RETURN 1
...
Function VoteYes(name String) Uint64
	10	IF EXISTS(name + "_name") == 1 THEN GOTO 20
	11	PRINTF "This poll doesn't exist!"
	12	RETURN 1
	
	20	IF ClosePoll(name) > 0 THEN GOTO 30
	21	RETURN 1
...
Function VoteNo(name String) Uint64
	10	IF EXISTS(name + "_name") == 1 THEN GOTO 20
	11	PRINTF "This poll doesn't exist!"
	12	RETURN 1
